...
beforeEach(() => {
    ...
    it('Check if report contains all Focus Area Report', function () {
        ...
        cy.get('[data-cy="mission-type"]').contains(this.data.focus_area1)
        cy.get('[data-cy="mission-type"]').contains(this.data.focus_area2)
        cy.get('[data-cy="mission-type"]').contains(this.data.focus_area3)
        cy.get('[data-cy="mission-type"]').contains(this.data.focus_area4)
        cy.get('[data-cy="mission-type"]').contains(this.data.focus_area5)
        cy.get('[data-cy="mission-type"]').contains(this.data.focus_area6)
        cy.get('[data-cy="mission-type"]').contains(this.data.focus_area7)
    })
    ...
    it("Search function in Focus area report", function() {
        ...
        cy.get('#example_filter > label > .form-control').type(this.data.focus_area7).click()
        cy.get('[data-cy="mission-type"]').should('contain', this.data.focus_area7)
        cy.get('[data-cy="mission-type"]').should('not.contain', this.data.focus_area1)
//      Add data validation 
