...
describe('community partners maps test', () => {
  ...
  it('Community partners page visit ', function() {
    ...
    cy.get(mapsLink).contains('Maps').click()
      .get(communityPartnersHref).eq(0).click()
  ...
  it('should interact with the map by zoom in and zoom', function() {
    const communityPartnersHref = `a[href="/community-Partner"]`,
      mapsLink = `a[class="nav-link dropdown-toggle"]`
    cy.get(mapsLink).contains('Maps').click()
      .get(communityPartnersHref).click()
  ...
  it('Card should be displayed when right clicked on a map marker', function() {
    const communityPartnersHref = `a[href="/community-Partner"]`,
      mapsLink = `a[class="nav-link dropdown-toggle"]`
    cy.get(mapsLink).contains('Maps').click()
      .get(communityPartnersHref).click()
  ...
  it('Card should be displayed when clicked on a map marker', function() {
    const communityPartnersHref = `a[href="/community-Partner"]`,
      mapsLink = `a[class="nav-link dropdown-toggle"]`
    cy.get(mapsLink).contains('Maps').click()
      .get(communityPartnersHref).click()
  ...
  it('All map markers should be visible on the map canvas', function() {
    const communityPartnersHref = `a[href="/community-Partner"]`,
      mapsLink = `a[class="nav-link dropdown-toggle"]`,
