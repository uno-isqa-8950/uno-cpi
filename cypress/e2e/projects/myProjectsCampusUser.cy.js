...
describe('my projects campus user test', () => {
beforeEach(() => {
    cy.on('uncaught:exception', (err) => {
      if(err.message.includes('is not a function') || err.message.includes('is not defined')  || err.message.includes('options')
      || err.message.includes('scrollTop')|| err.message.includes('reading \'addEventListener\'')
