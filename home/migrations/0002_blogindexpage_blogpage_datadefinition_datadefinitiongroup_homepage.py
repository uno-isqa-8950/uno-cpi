    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.Page')),
                ('introduction', models.TextField(blank=True, help_text='Text to describe the page')),
                ('body', wagtail.fields.StreamField([('heading_block', wagtail.blocks.StructBlock([('heading_text', wagtail.blocks.CharBlock(classname='title', required=True)), ('size', wagtail.blocks.ChoiceBlock(blank=True, choices=[('', 'Select a header size'), ('h2', 'H2'), ('h3', 'H3'), ('h4', 'H4')], required=False))])), ('two_column_block', wagtail.blocks.StructBlock([('left_column', wagtail.blocks.RichTextBlock(icon='arrow-right', label='Left column content')), ('right_column', wagtail.blocks.RichTextBlock(icon='arrow-right', label='Right column content'))])), ('three_column_block', wagtail.blocks.StructBlock([('left_column', wagtail.blocks.RichTextBlock(icon='arrow-right', label='Left column content')), ('middle_column', wagtail.blocks.RichTextBlock(icon='arrow-up', label='Middle column content')), ('right_column', wagtail.blocks.RichTextBlock(icon='arrow-right', label='Right column content'))])), ('paragraph_block', wagtail.blocks.RichTextBlock(icon='fa-paragraph', template='blocks/paragraph_block.html')), ('image_block', wagtail.blocks.StructBlock([('image', wagtail.images.blocks.ImageChooserBlock(required=True)), ('caption', wagtail.blocks.CharBlock(required=False)), ('attribution', wagtail.blocks.CharBlock(required=False))])), ('block_quote', wagtail.blocks.StructBlock([('text', wagtail.blocks.TextBlock()), ('attribute_name', wagtail.blocks.CharBlock(blank=True, label='e.g. Mary Berry', required=False))])), ('embed_block', wagtail.embeds.blocks.EmbedBlock(help_text='Insert an embed URL e.g https://www.youtube.com/embed/SGJFWirQ3ks', icon='fa-s15', template='blocks/embed_block.html'))], blank=True, verbose_name='Page body')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bottom', wagtail.fields.StreamField([('heading_block', wagtail.blocks.StructBlock([('heading_text', wagtail.blocks.CharBlock(classname='title', required=True)), ('size', wagtail.blocks.ChoiceBlock(blank=True, choices=[('', 'Select a header size'), ('h2', 'H2'), ('h3', 'H3'), ('h4', 'H4')], required=False))])), ('two_column_block', wagtail.blocks.StructBlock([('left_column', wagtail.blocks.RichTextBlock(icon='arrow-right', label='Left column content')), ('right_column', wagtail.blocks.RichTextBlock(icon='arrow-right', label='Right column content'))])), ('three_column_block', wagtail.blocks.StructBlock([('left_column', wagtail.blocks.RichTextBlock(icon='arrow-right', label='Left column content')), ('middle_column', wagtail.blocks.RichTextBlock(icon='arrow-up', label='Middle column content')), ('right_column', wagtail.blocks.RichTextBlock(icon='arrow-right', label='Right column content'))])), ('paragraph_block', wagtail.blocks.RichTextBlock(icon='fa-paragraph', template='blocks/paragraph_block.html')), ('image_block', wagtail.blocks.StructBlock([('image', wagtail.images.blocks.ImageChooserBlock(required=True)), ('caption', wagtail.blocks.CharBlock(required=False)), ('attribution', wagtail.blocks.CharBlock(required=False))])), ('block_quote', wagtail.blocks.StructBlock([('text', wagtail.blocks.TextBlock()), ('attribute_name', wagtail.blocks.CharBlock(blank=True, label='e.g. Mary Berry', required=False))])), ('embed_block', wagtail.embeds.blocks.EmbedBlock(help_text='Insert an embed URL e.g https://www.youtube.com/embed/SGJFWirQ3ks', icon='fa-s15', template='blocks/embed_block.html'))], blank=True, verbose_name='Home content block')),
