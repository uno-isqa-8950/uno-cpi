...
function getMapFilteredData (communityPartners, mission_value ,comm_type, legislative_value, academic_year, college_name, campus_partner, search) {
    ...
    var not_set = [undefined, "All", '', 'All Focus Areas', 'All Community Partner Types', 'All Colleges and Main Units', 'All Campus Partners', 'All City Council Districts', 'All Academic Years'];
