 ...
 *   https://datatables.net/download/#bs4/dt-1.10.18/af-2.3.2/b-1.5.4/b-colvis-1.5.4/b-html5-1.5.4/b-print-1.5.4/cr-1.5.0/fc-3.2.5/r-2.2.2/rg-1.1.0/rr-1.2.4/sl-1.2.6
 *
 * Included libraries:
 *   DataTables 1.10.18, AutoFill 2.3.2, Buttons 1.5.4, Column visibility 1.5.4, HTML5 export 1.5.4, Print view 1.5.4, ColReorder 1.5.0, FixedColumns 3.2.5, Responsive 2.2.2, RowGroup 1.1.0, RowReorder 1.2.4, Select 1.2.6
 */
...
(function (h) {
	...
	n.ext = x = {
		buttons: {},
		classes: {},
		build: "bs4/dt-1.10.18/af-2.3.2/b-1.5.4/b-colvis-1.5.4/b-html5-1.5.4/b-print-1.5.4/cr-1.5.0/fc-3.2.5/r-2.2.2/rg-1.1.0/rr-1.2.4/sl-1.2.6",
		errMode: "alert",
		feature: [],
		search: [],
		selector: {
...
(function (f) {
	...
	v.ext.buttons.excelHtml5 = {
		...
		action: function (a, b, d, c) {
			...
			f("mergeCells", h).before(r(h, "autoFilter", {
				attr: {
