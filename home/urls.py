...
urlpatterns = [
   ...
   path('projectInfo_old/', views.project_partner_info_old, name='project_partner_info_old'),
   path('projectInfo/', views.project_partner_info, name='project_partner_info'),
   path('projectTopicInfo/', views.focus_topic_info, name='focus_topic_info'),
   path('primaryFocusTopicInfo/', views.primary_focus_topic_info, name='primary_focus_topic_info'),
