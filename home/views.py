...
def issueaddress(request):
    ...
    sub={'type':'xrange','name': 'Educational Support', 'id': 'Educational Support', 'yAxis': 1, 'data': [{'x': 1, 'x2': 11, 'y': 0, 'color': 'turquoise'}, {'x': 3, 'x2': 13, 'y':
1, 'color': 'turquoise'}, {'x': 3, 'x2': 13, 'y': 2, 'color': 'turquoise'}, {'x': 2, 'x2': 12, 'y': 3, 'color': 'turquoise'}, {'x': 1, 'x2': 11, 'y': 4, 'color': 'turquoise'}]}, {'type':'scatter','name'
: 'Educational Support', 'id': 11, 'yAxis': 1, 'data': [{'x': 1,'x2':3, 'y': 0}, {'x': 3, 'y': 1}, {'x': 3, 'y': 2}, {'x': 2, 'y': 3}, {'x': 1, 'y': 4}]}, {'name': 'Educational Support', 'id': 21, 'yAxis': 1, 'data': [{'x': 11, 'y': 0}, {'x': 3, 'y': 1}, {'x': 3, 'y': 2}, {'x': 2, 'y': 3}, {'x': 1, 'y': 4}]}, {'name': 'Health and Wellness', 'id': 'Health and Wellness',
'yAxis': 1, 'data': [{'x': 1, 'x2': 1, 'y': 0, 'color': 'turquoise'}, {'x': 1, 'x2': 1, 'y': 1, 'color': 'turquoise'}, {'x': 2, 'x2': 2, 'y': 2, 'color': 'turquoise'}, {'x': 2, 'x2':
 2, 'y': 3, 'color': 'turquoise'}, {'x': 1, 'x2': 1, 'y': 4, 'color': 'turquoise'}]}
    Academic_Year = {
    ...
    # subdrill.update(subdrillstart)
    # subdrill.update(subdrillend)
