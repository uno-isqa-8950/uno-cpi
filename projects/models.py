...
class Project (models.Model):
    ...
    engagement_type = models.ForeignKey('EnagagementType',on_delete=models.CASCADE ,null=True)
    ...
    total_economic_impact =models.DecimalField(max_digits=15, decimal_places=4,null=False, blank=True)
...
class EnagagementType(models.Model):
