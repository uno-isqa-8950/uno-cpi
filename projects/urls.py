...
urlpatterns = [
    ...
    path('projects-public-report/', views.projectsPublicReport, name='projectspublicreport'),
    ...
    path('projects-private-report/', views.projectsPrivateReport, name='projectsprivatereport'),
