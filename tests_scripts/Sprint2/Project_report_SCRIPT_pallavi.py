...
class UnoCpi(unittest.TestCase):
    ...
    def test_website(self):
        ...
        driver.get('http://127.0.0.1:8000/projectspublicreport/') #Shows Project Report when NOT logged in
        time.sleep(1)
        ...
        time.sleep(1)
        driver.get('http://127.0.0.1:8000/projectspublicreport/') #Shows Project Report when logged in
        time.sleep(3)
