...
class admin_login(unittest.TestCase):
    ...
    def test_blog(self):
        ...
        driver.get("https://uno-cpi-cat.herokuapp.com/")
        ...
        # for Status, status is commented out to show that it will choose active status as default
